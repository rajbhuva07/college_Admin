...
const AddCategory = () => {
    ...
    useEffect(() => {
        if (id) {
            const fetchCategoryData = async () => {
                try {
                    const response = await fetch(`https://college-backend.vercel.app/categories/${id}`);
                    if (response.ok) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`https://college-backend.vercel.app/categories${id ? `/${id}` : ''}`, requestOptions);
    ...
    const handleDelete = async (categoryId) => {
        if (window.confirm('Are you sure you want to delete this category?')) {
            try {
                const response = await fetch(`https://college-backend.vercel.app/categories/${categoryId}`, {
                    method: 'DELETE'
                });
