...
const ListProduct = () => {
    ...
    const fetchProducts = async () => {
        try {
            const response = await fetch('https://college-backend.vercel.app/products');
            if (response.ok) {
    ...
    //     try {
    //         const response = await fetch(`https://college-backend.vercel.app/removeProduct/${productId}`, {
    //             method: 'delete',
    //         });
